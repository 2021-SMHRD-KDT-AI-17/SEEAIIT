      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        customButtons:{
        	...
        	myCustomButton:{
        	    ...
        	    click: function() {
        	        // admin 여부 확인
        	        var isAdmin = /1/.test("${loginMember.rank_num}");

        	        if (isAdmin) {
        	            // 부트스트랩 모달 열기
        	            $("#exampleModal").modal("show");
        	        } else {
        	            alert("강사만 일정을 추가할 수 있습니다.");
        	        }
        	    }
        	},
        	mySaveButton: {
    ...
    // 데이터베이스에서 가져온 캘린더 정보를 이벤트로 추가합니다.
 	{
      ...
      $("#deleteEventBtn").on("click", function() {
	        var isAdmin = /1/.test("${loginMember.rank_num}"); // userEmail은 서버에서 받아온 사용자의 이메일입니다.
